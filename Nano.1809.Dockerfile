...
FROM tonysneed/dotnet-runtime-windowsdesktop:3.1-nanoserver-1809 AS base
WORKDIR /app
...
# docker build -t tonysneed/hello-wpf-core:nanoserver-1809 -f Nano.1809.Dockerfile .
# docker run tonysneed/hello-wpf-core:nanoserver-1809